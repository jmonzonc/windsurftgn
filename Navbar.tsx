      ...
      <nav className={cn("fixed top-0 inset-x-0 z-[1000] transition-all duration-500", navBg)}>
        <div className="max-w-[1200px] mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-6 items-center">
            {links.map((l) => (
              <Link key={l.label} href={l.href} className="font-body text-sm font-medium text-white/65 no-underline hover:text-white transition-colors duration-300">
                {l.label}
              </Link>
            ))}
          ...
          <button
            ...
            className="md:hidden relative z-[1001] w-10 h-10 flex flex-col items-center justify-center gap-1.5 bg-transparent border-none"
            aria-label="Menu"
          >
