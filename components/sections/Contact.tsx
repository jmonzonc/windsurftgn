    ...
    <section id="contacto" ref={ref as React.RefObject<HTMLElement>} className="bg-gradient-to-b from-ice to-white py-28 px-5 relative">
      <div className="max-w-[960px] mx-auto text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4"
          ...
          {items.map((item, i) => <ContactCard key={i} icon={ICONS[i]} {...item} />)}
        </div>
        <div className="mt-12 rounded-[28px] overflow-hidden h-[280px] relative bg-gradient-to-br from-ocean/[0.08] to-turq/[0.06] border border-ocean/[0.06]"
          ...
          <iframe src={`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3019.5!2d${SITE.coords.lng}!3d${SITE.coords.lat}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDHCsDEzJzAyIk4gMcKwMycxNyJF!5e0!3m2!1ses!2ses!4v1`}
...
function ContactCard({ icon, title, text, sub }: { icon: string; title: string; text: string; sub: string }) {
  const [h, setH] = useState(false);
  return (
    <div onMouseEnter={() => setH(true)} onMouseLeave={() => setH(false)}
      className="bg-white rounded-3xl py-9 px-[22px] cursor-pointer transition-all duration-400 ease-expo"
