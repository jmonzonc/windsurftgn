        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 shadow-[0_4px_20px_rgba(0,104,214,0.04)] font-body text-sm sm:text-base text-gray-500 leading-relaxed space-y-4 sm:space-y-6">
          {locale === "en" ? (
            <>
              ...
              <p>Users have the right to access, rectify, delete, limit, port, and object to the processing of their data. To exercise these rights, contact us at <strong>609 874 869</strong>.</p>
            </>
          ) : locale === "ca" ? (
            <>
              ...
              <p>Els usuaris tenen dret a accedir, rectificar, suprimir, limitar, portar i oposar-se al tractament de les seves dades. Per exercir aquests drets, contacteu-nos al <strong>609 874 869</strong>.</p>
            </>
          ) : (
            <>
              ...
              <p>Los usuarios tienen derecho a acceder, rectificar, suprimir, limitar, portar y oponerse al tratamiento de sus datos. Para ejercer estos derechos, contacte con nosotros en el <strong>609 874 869</strong>.</p>
            </>
          )}
        </div>
      </div>
